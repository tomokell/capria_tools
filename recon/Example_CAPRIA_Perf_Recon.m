% Reconstruct 4D CAPRIA perfusion images
%
% Tom Okell, June 2022
...
SpatialMtxSz = 52; % Nominal spatial matrix size for reconstruction: this gives voxel sizes of nominal FOV (183 mm) / 52 = 3.5 mm
TempResn = 323; % Temporal resolution for reconstruction (ms)
...
L.LLR.p =   5; % LLR patch size

OutName = ['CFA_Perf']; % Output directory name
